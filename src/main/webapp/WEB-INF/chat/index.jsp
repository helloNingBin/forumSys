...
<script src="${REQUEST_BASE_PATH}/js/chat/webSocket.js?ver=5"></script>
<style>
.nav{ background:#fff}
...
.group .group_tit{ height:100px;  padding:0px 20px; line-height:100px; background:url(${REQUEST_BASE_PATH}images/70%20Basic%20Icons-all-59.svg) 25px 29px no-repeat }
...
.cheg .group_tit{background:url(${REQUEST_BASE_PATH}images/70%20Basic%20Icons-all-60.svg) 25px 29px no-repeat !important}
...
.comment .zan{}
.comment .zan h1{ color:#3773A7; font-size:30px; background:url(${REQUEST_BASE_PATH}images/a7.jpg) 0px 0px no-repeat; padding-left:60px; line-height:38px; font-weight:normal}
.comment .zan h1 span{}
...
<body id="body_bg">
	<div class="homepage">
    	        <div class="set" id="toggle-sidebar" style="width: 136.364px; float:left">
					<img src="${REQUEST_BASE_PATH}images/a1.png" />
				</div>
			...
			<div class="swiper-container" id="swiper-container3" style="width:100%;">
				<div class="swiper-wrapper" style="height: 488px; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
					...
					<div class="swiper-slide" style="width: 750px;height:900px;overflow:auto">
					  <c:forEach items="${friendGroupList}" var="g">
		                  <div class="group news">
		                     <div class="group_tit">
		                         <h1>${g.groupName}</h1>
		                     </div>
		                     <ul>
					      <c:forEach items="${friendsInGroupList}" var="f">
					          <c:if test="${g.id eq f.firendGroupId }">
		                        	  <li>
		                            	<div class="lf" memberId="${f.firendMember.id}">
		                                	<img src="${REQUEST_BASE_PATH}images/a1.png" />
		                                     <h1>${f.firendMember.nickName}</h1>
		                                </div>
		                                <div class="rt">
		                                	<span>信息未读数量显示在这里</span>
		                                </div>
		                             </li>
					          </c:if>
					      </c:forEach>
...
　　蛾儿雪柳黄金缕，笑语盈盈暗香去。众里寻他千百度。蓦然回首，那人却在，灯火阑珊处。
                                    ...
                                    <div class="carry">
                                        ...
                                        <div class="carry_rt">
                                        	<span style="background:url(${REQUEST_BASE_PATH}images/a5.jpg)"></span>
                                            <span style="background:url(${REQUEST_BASE_PATH}images/a6.jpg)"></span>
                                        </div>
                                        <div style="clear:both"></div>
                                    </div>
                                    <div class="comment">
...
<div id="dowebok">
		<ul class="nav">
			<li class="nav_li" >
            	<img src="${REQUEST_BASE_PATH}images/a1.png" style=" display:block;margin:auto" />
                <p class="nickname">幽谷草</p>
                <p class="mood">今天天气不错，挺风和日丽的。我们下午没有课。。。</p>
            </li>
			<li><a href="data.html" style="background:url(${REQUEST_BASE_PATH}images/70%20Basic%20Icons-all-05.svg) 75px 30px no-repeat;">个人资料</a></li>
            <li><a href="feedback.html" style="background:url(${REQUEST_BASE_PATH}images/70%20Basic%20Icons-all-63.svg) 75px 30px no-repeat">意见反馈</a></li>
			<li><a href="about_us.html" style="background:url(${REQUEST_BASE_PATH}images/70%20Basic%20Icons-all-16.svg) 75px 30px no-repeat">关于我们</a></li>
